      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {slides.slice(0, 4).map((slide, index) => (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6, delay: index * 0.1 }}
            className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 rounded-xl p-6 shadow-lg hover:shadow-xl dark:shadow-black/20 dark:hover:shadow-black/30 transition-all duration-300 hover:-translate-y-1 cursor-pointer group border border-gray-200/50 dark:border-gray-700/50"
            onClick={() => goToSlide(index)}
          >
            <div className="flex items-center mb-4">
              <div
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
        {slides.slice(4).map((slide, index) => (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6, delay: (index + 4) * 0.1 }}
            className="bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 rounded-xl p-6 shadow-md hover:shadow-lg dark:shadow-black/10 dark:hover:shadow-black/20 transition-all duration-300 hover:-translate-y-1 cursor-pointer group border border-gray-100 dark:border-gray-700"
            onClick={() => goToSlide(index + 4)}
          >
            <div className="flex items-center mb-4">
              <div
