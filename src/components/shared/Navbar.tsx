...
//     ? " bg-white dark:bg-[#3b3b3b] text-black dark:text-white  border-gray-200  dark:border-gray-700"
//     : theme === "dark"
//     ? "bg-[#3b3b3b] text-white border-gray-700"
...
//                   className={cn(
//                     "relative transition-colors font-medium group py-2",
//                     isActive ? " text-black dark:text-white " : "text-gray-300 hover:text-white"
//                   )}
//                 >
//                   {link.label}
//                   <span
...
//             {/* Cart */}
//             <Link href="/cart" className="relative group p-2">
//               <AiOutlineShoppingCart className="w-6 h-6 text-gray-700 hover:text-gray-700 dark:text-white dark:hover:text-gray-300 transition-colors" />
//               {itemCount > 0 && (
//                 <span className="absolute -top-1 -right-1 bg-red-500 text-white text-xs rounded-full px-1.5 py-0.5 shadow min-w-[20px] h-5 flex items-center justify-center">
//                   {itemCount}
//                 </span>
...
//                   variant="ghost"
//                   size="icon"
//                   className="text-gray-700 dark:text-white dark:hover:text-gray-300"
//                 >
//                   <Sun className="h-[1.2rem] w-[1.2rem] rotate-0 scale-100 transition-all dark:-rotate-90 dark:scale-0" />
//                   <Moon className="absolute h-[1.2rem] w-[1.2rem] rotate-90 scale-0 transition-all dark:rotate-0 dark:scale-100" />
//                   <span className="sr-only">Toggle theme</span>
...
//                   <Button
//                     variant="ghost"
//                     className="relative h-10 w-10 rounded-full text-white hover:text-gray-300"
//                   >
//                     <User className="h-5 w-5" />
//                   </Button>
//                 </DropdownMenuTrigger>
