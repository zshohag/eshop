...
import { useProducts, useProductBySlug } from "@/lib/api/products";
...
export default function ProductDetailsPage() {
  ...
  const { data: product, isLoading, isError } = useProductBySlug(slug as string); // Use slug hook
            ...
            .map((related) => (
              ...
              >
                ...
                <div className="px-2 pb-4 flex flex-col mt-auto">
                  ...
                  <Link href={`/products/${related.slug}`} className="w-full">
